...
if ($totalselected > 0) {
  ...
  // Page Sorting
  echo "<tr><form method='post' action='admin.php?op=ABBlockedRange'>\n";
  ...
  while ($getIPs = $db->sql_fetchrow($result)) {
    ...
    echo "<td align='center'>&nbsp;<a href='admin.php?op=ABPrintBlockedRangeView&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."' target='_blank'><img src='images/sentinel/print.png' border='0' alt='"._AB_PRINT."' title='"._AB_PRINT."' height='16' width='16'></a>&nbsp;<a ";
    echo "href='admin.php?op=ABBlockedRangeView&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."' target='_blank'><img src='images/sentinel/view.png' border='0' alt='"._AB_VIEW."' title='"._AB_VIEW."' height='16' width='16'></a>&nbsp;<a ";
    echo "href='admin.php?op=ABBlockedRangeEdit&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."&amp;min=$min&amp;column=$column&amp;direction=$direction&amp;xop=$op'><img src='images/sentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
    echo "href='admin.php?op=ABBlockedRangeDelete&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."&amp;min=$min&amp;column=$column&amp;direction=$direction&amp;xop=$op'><img src='images/sentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
    echo "</tr>\n";
  }
  // Page Numbering
  ...
  if ($pages != 1 && $pages != 0) {
    echo "<tr bgcolor='$bgcolor1'><td colspan='5'><img src='images/pix.gif' height='2' width='2'></td></tr>\n";
    echo "<tr><form action='admin.php?op=ABBlockedRange' method='post'>\n";
