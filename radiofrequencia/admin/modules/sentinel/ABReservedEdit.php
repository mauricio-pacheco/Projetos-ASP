...
$pagetitle = _AB_NUKESENTINEL.": "._AB_EDITRESERVED;
include("header.php");
title($pagetitle);
OpenMenu();
ipbanmenu();
...
echo "<tr><td align='center' colspan='2'>"._AB_EDITRESERVEDS."</td></tr>\n";
...
echo "</select></td></tr>\n";
echo "<input type='hidden' name='op' value='ABReservedEditSave'>\n";
