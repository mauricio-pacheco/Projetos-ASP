...
$test1 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_protected_ranges WHERE ip_lo<='$longip_lo' AND ip_hi>='$longip_lo'");
$test2 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_protected_ranges WHERE ip_lo<='$longip_hi' AND ip_hi>='$longip_hi'");
...
if($testnum1 > 0 OR $testnum2 >0) {
  ...
  Header("Location: admin.php?op=ABProtectedList");
}
