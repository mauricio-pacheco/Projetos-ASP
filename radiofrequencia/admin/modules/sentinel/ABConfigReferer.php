...
echo "<tr><td align='center' bgcolor='$bgcolor2' colspan='2'><b>"._AB_REFERERBLOCKER."</b></td></tr>\n";
echo "<input type='hidden' name='xblocker_row[block_name]' value='referer'>\n";
blocker_config($blocker_row);
echo "<tr><td bgcolor='$bgcolor2' valign='top'>".help_img(_AB_HELP_020)." "._AB_REFERERLIST.":</td><td><textarea name='xblocker_row[list]' rows='5' cols='40'>".$blocker_row['list']."</textarea></td></tr>\n";
