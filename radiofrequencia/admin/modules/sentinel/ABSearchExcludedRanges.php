...
$pagetitle = _AB_NUKESENTINEL.": "._AB_SEARCHEXCLUDEDRANGES;
include("header.php");
title($pagetitle);
OpenMenu();
ipbanmenu();
...
if(isset($sip)) {
  ...
  if ($totalselected > 0) {
    ...
    while ($getIPs = $db->sql_fetchrow($result)) {
      ...
      echo "<td align='center'>&nbsp;<a href='admin.php?op=ABExcludedRangeEditEdit&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."&amp;min=$min&amp;column=$column&amp;direction=$direction&amp;sip=$sip&amp;xop=$op'><img src='images/sentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
      echo "href='admin.php?op=ABExcludedRangeDelete&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."&amp;min=$min&amp;column=$column&amp;direction=$direction&amp;sip=$sip&amp;xop=$op'><img src='images/sentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
      echo "</tr>\n";
      $x++;
    }
    echo "</table>\n";
