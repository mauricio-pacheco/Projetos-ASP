...
$test1 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_blocked_ranges WHERE ip_lo<='$longip_lo' AND ip_hi>='$longip_lo'");
$test2 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_blocked_ranges WHERE ip_lo<='$longip_hi' AND ip_hi>='$longip_hi'");
