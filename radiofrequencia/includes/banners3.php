...
if ($numrows>0) {
    ...
    if ($bidinfo['flash']==1 AND $bidinfo['code']==0) {
        ...
        $tbanners3 .= "\n<param name=movie value='images/banners/clicks_v.swf'>";
        $tbanners3 .= "\n<param name=quality value=high>";
        $tbanners3 .= "\n<param name=FlashVars value='imageurl=".$bidinfo['imageurl']."&bid=$bannum'>";
        $tbanners3 .= "\n<embed src='images/banners/clicks_v.swf?imageurl=".$bidinfo['imageurl']."&bid=$bannum' quality=high pluginspage=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width='".$bidinfo['width']."' height='".$bidinfo['height']."'>";
        $tbanners3 .= "\n</embed> ";
        $tbanners3 .= "\n</object>\n\n";
        ...
        $tbanners3  = "<a href='clicks.php?bid=$bannum' target='_blank'><img src='".$bidinfo['imageurl']."' border='0' alt='".$bidinfo['alttext']."' title='".$bidinfo['alttext']."' height='".$bidinfo['height']."' width='".$bidinfo['width']."'></a>";
    }
} else {
    $tbanners3  = "<a href='modules.php?name=$modname'><img src='modules/$modname/images/ban-banner-3.png' border='0' alt='$sitename' title='$sitename'></a>";
}
