...
if (eregi("block-Top10Vote_JScroll.php", $_SERVER['SCRIPT_NAME'])) {
...
while ($pic = $db->sql_fetchrow($result)) {
	...
	if ($pic['visible'] == 1) {
	    if (is_user($user)) {
		$messages .= "messages[$i]=\"<b>.:N<u>o</u> $i:.</b><br>Votes:$pic[votes]x<br><a href='$baseurl&amp;do=showpic&amp;pid=$pic[pid]'>$thumb</a><br>$pic[name]<br>by<br>$pic[submitter]<hr width='50%'>\"\n";
	    } else {
		$messages .= "messages[$i]=\"<b>.:N<u>o</u> $i:.</b><br>Votes:$pic[votes]x<br>$thumb<br>$pic[name]<br>by<br>$pic[submitter]<hr width='50%'>\"\n";
	    }
	} else {
		$messages .= "messages[$i]=\"<b>.:N<u>o</u> $i:.</b><br>Votes:$pic[votes]x<br><a href='$baseurl&amp;do=showpic&amp;pid=$pic[pid]'>$thumb</a><br>$pic[name]<br>by<br>$pic[submitter]<hr width='50%'>\"\n";
	}
 ...
 if($messages== "") {
	$messages = "messages[1]=\"<br><br><br><br><br><b>None<br>Voted<br>Pictures</b>\"\n";
 }
...
messages[0]=\"<br><br><br><br>Top Ten<br>Vote Picture<br>Pause Scrolling<br>Scritped<br>by<br><a href='http://www.modscity.com' target='_blank'>ModsCity.Com</a><br>\"
$messages
