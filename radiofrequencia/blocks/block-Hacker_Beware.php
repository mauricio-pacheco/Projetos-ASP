...
if (stristr($_SERVER['PHP_SELF'], "block-Hacker_Beware.php") OR stristr($_SERVER['SCRIPT_NAME'], "block-Hacker_Beware.php")) {
...
$content  = "<center><img src=\"images/sentinel/Sentinel_Large.png\" alt=\"You have been warned!\" title=\"You have been warned!\"><br />We have caught $total_ips shameful hackers.</center>";
