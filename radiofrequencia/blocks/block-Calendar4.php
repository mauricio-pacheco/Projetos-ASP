...
if (eregi("block-Calendar4.php",$PHP_SELF)) {
...
$content = "<center><font class=\"content\"><img src=\"images/calendar/ballr.gif\">$calcat1&nbsp;&nbsp;<img src=\"images/calendar/ballg.gif\">$calcat2<br /><img src=\"images/calendar/ballb.gif\">$calcat3&nbsp;&nbsp;<img src=\"images/calendar/ballw.gif\">$calcat4<br /><img src=\"images/calendar/bally.gif\">$calcat5</font></center><br />";
        ...
        $content .= "<img src=\"images/calendar/ball$barcolorchar.gif\" border=0> <a href=\"modules.php?name=$module_name&file=index&type=view&eid=$eid\">$title</a><br>";
        }
       }
}
$selmon = array();
...
$Today_m = Date("m");
$Today_y = Date("Y");
$content .= "\n<BR><center><TABLE border=0 cellspacing=1 cellpadding=2>";
$content .= "\n<TR>\n<TH colspan=7><FORM Name = \"selectcalendar\" action = \"index.php\">\n<center><FONT class=\"tiny\">";
$content .="<B><SELECT Name = \"calsetmonth\" onChange=\"javascript:document.selectcalendar.submit()\">
...
<BR><SELECT NAME=\"calsetyear\" onChange=\"javascript:document.selectcalendar.submit()\">
...
$content .= "\n<TR>\n<td></td></tr></TABLE>\n<BR>"
    ."<a href=\"modules.php?name=$module_name&file=submit\">&middot;<B><FONT FACE=verdana size=\"1\">"
      ."Create an event</font></b>&middot;</a><BR>"
    ."<a href=\"modules.php?name=$module_name&file=index&Date=$Date&type=month\">&middot;<B><FONT FACE=verdana size=\"1\">"
      ."Enlarge Month</font></B>&middot;</a><BR>"
    ."<a href=\"modules.php?name=$module_name&file=index&Date=$Date&type=year\">&middot;<B><FONT FACE=verdana size=\"1\">"
      ."View  Year</font></B>&middot;</a><BR><BR></CENTER>";
