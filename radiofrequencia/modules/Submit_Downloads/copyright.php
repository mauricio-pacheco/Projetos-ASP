...
$license = "Copyright &copy; 2000-2004 NukeScripts Network";
$download_location = "";
$module_version = "";
$release_date = "";
$module_description = "";
...
function show_copyright() {
    ...
    echo "$mod_name module for PHP-Nuke<br>[<a href=\"javascript:void(0)\" onClick=javascript:self.close()>Close Window</a>]</font></td>\n";
    echo "</center>\n<hr>\n";
