...
if ($totalmods != 0) {
  while($ridinfo = $db->sql_fetchrow($result)) {
    ...
    echo "</td>\n";
    echo "<td align='center'>( <a href='admin.php?op=DownloadModifyRequestsAccept&amp;rid=".$ridinfo['rid']."'>"._ACCEPT."</a> / ";
    echo "<a href='admin.php?op=DownloadModifyRequestsIgnore&amp;rid=".$ridinfo['rid']."'>"._IGNORE."</a> )</td>\n";
