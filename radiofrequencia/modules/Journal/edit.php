...
include("modules/$module_name/functions.php");
	...
	if ($username != $row[aid]):
        ...
        function list20($username, $bgcolor1, $bgcolor2, $bgcolor3) {
            global $user_prefix, $user_prefix, $db, $module_name;
            openTable();
            ...
            echo ("</tr>");
            $sql = "SELECT jid, aid, title, pdate, ptime, mdate, mtime, status, mood FROM ".$user_prefix."_journal WHERE aid='$username' order by 'jid' DESC";
            $result = $db->sql_query($sql);
            ...
            while ($row = $db->sql_fetchrow($result)) {
                ...
                $sqlscnd = "SELECT cid from ".$user_prefix."_journal_comments where rid='$jaid'";
