...
$module_name = "Event Calendar"; // If you dont fill this in the module directory name is used
$author_name = "Original author - Rob Sutton. Development continued by Holbrookau.";
$author_email = "phpnuke@holbrookau.net";
$author_homepage = "http://phpnuke.holbrookau.net";
$license = "GNU/GPL";
$download_location = "http://phpnuke.holbrookau.net/modules.php?name=Downloads";
$module_version = "2.13 - March 16th, 2004";
$module_description = "Provides an event calendar for PHP-Nuke communities.";
...
function show_copyright() {
    global $module_name, $author_name, $author_email, $author_homepage, $license, $download_location, $module_version, $module_description;
    ...
    if ($module_name == "") { $module_name = basename(dirname(__FILE__)); }
