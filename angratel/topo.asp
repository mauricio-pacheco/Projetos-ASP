...
<body background="bg.jpg" topmargin=0 leftmargin=0 marginwidth=0 marginheight=0 text=<%=cor4%>>
	...
	<basefont face="<%=fonte%>">
			  <table border="0" width="778" bgcolor=#ffffff cellpadding="1" cellspacing="1">
			  		 <tr><td valign="bottom" nowrap>&nbsp;&nbsp;<img src="<%=dirlingua%>/imagens/logo.gif"  border="0"></td>
					 		 <td valign="bottom" nowrap align="right"><table><tr><td valign=center>&nbsp;&nbsp;<img src="<%=dirlingua%>/imagens/serv.gif"  border="0"></td>
							 <td valign=top>
		  		  ...
		  		  <table>
		  		   <tr><td bgcolor=#ffffff>
				   		   <table cellspacing="1" cellpadding="1" width="100%">
						   		  <tr><td coldiv=2 align="right"><font face="<%=fonte%>" style=font-size:11px; color=#000000><b></td></tr>
...
'Personaliza o menu se o cliente estiver logado
 if session("usuario") = "" then %>
 		...
 		<table width="778" height="10" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" valign="center">
			 <tr valign="center">
			   <td bgcolor="<%=cor2%>" height="23" align="left" valign=bottom><table cellpadding="0" cellspacing="0"><tr><td height=5></td></tr></table><font color="<%=fontebranca%>" face="<%=fonte%>" style=font-size:11px;><b>&nbsp;<img src="espaco" border="0" align="middle" WIDTH="0" HEIGHT="16"><a class=menu  href="default.asp" onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg4%>';return true;" >PRINCIPAL</a>&nbsp;<table cellpadding="0" cellspacing="0"><tr><td height=2></td></tr></table></td>
...
<%end if%>
		...
		<div id="layer1" style="position:absolute; top:102px; z-index:5"><table border=0 cellspacing=0 width=778 bgcolor=#ffffff cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor="bcbcbc" align=left></td></tr><tr><td height=5></td></tr></table></div>
		<div id="layer1" style="position:absolute; top:107px; z-index:7"><table border=0 cellspacing=0 width=778 cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor="bcbcbc" align=left></td></tr><tr><td height=5></td></tr></table></div>
		<div id="layer1" style="position:absolute; top:113px; width:100px; height:15px; z-index:8"><table border="0" cellspacing="0" cellpadding="0" width="163"><tr bgcolor="<%=cor3%>"><td bgcolor="<%=cor3%>" width=25>&nbsp;<img src="<%=dirlingua%>/imagens/seta.gif" border="0"></td><td bgcolor="<%=cor3%>"><font style=font-size:11px;font-family:<%=fonte%>; color=ffffff><b><%=UCASE(strLg12)%></b></td></tr></table></div>
		<div id="layer1" style="position:absolute; top:113px; z-index:1">
			 <table border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" width="778"><tr><td width="128" valign="top" align="center">
...
Set menu = Nothing%> 
		 ...
		 <tr><td><div id="layer1" style="position:absolute; left:0px; width: 300px;">
		 			  <table border="0" cellspacing="0" cellpadding="0" width="163"><tr><td bgcolor="<%=cor3%>" width=20>&nbsp;<img src="<%=dirlingua%>/imagens/seta.gif" border="0"></td><td bgcolor="<%=cor3%>"><font style=font-size:11px;font-family:<%=fonte%> color=ffffff><b>&nbsp;<%=UCASE(strLg13)%></b></font></td></tr></table></td></tr></div>
	...
	<div align=center>
		 <input type=image src=<%=dirlingua%>/imagens/pesquisar.gif onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg21%>';return true;"></div></td></tr></form><tr><td><div id="layer1" style="position:absolute; left:0px;width:300px;">
		 		<table border="0" cellspacing="0" cellpadding="0" width=163>
					   <tr><td bgcolor="" width=20></td><td bgcolor="<%=cor3%>"></td></tr></table></div></td></tr>
					   <tr><td></td></tr>
