...
<%else%>
		<table><tr><td align="left" valign="top">
					   <table border="0" cellspacing="4" cellpadding="4" width=590>
						...
						<tr><td><font face="<%=fonte%>"  style=font-size:11px color=000000><b>Escolha do produto</b><br><div align=justify>&nbsp;&nbsp;&nbsp;Ao encontrar o produto desejado, clique sobre <img src="<%=dirlingua%>/imagens/detalhes.gif" width="83" height="18" border="0"> para obter mais informações e caso queira comprá-lo basta escolher a quantidade do item escolhido e clicar em <i>"Comprar Produto"</i>.</td>
