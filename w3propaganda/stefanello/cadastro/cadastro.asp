...
//--->
  ...
  - Seja bem vindo <span style="color: #FFFFFF">Administrador</span> - <a class=home_titulo7000 href="fujir.asp">Sair do Sistema</a>&nbsp;&nbsp; * Campos Obrigat&oacute;rios</span></FONT></TD>
          </TR></TBODY></TABLE></TD>
  <TR>
  <TR>
    <TD vAlign=top>
                          ...
                          <TR>
                            <TD vAlign=top width="60%"><FORM name=cadastro action=cadastrar.asp enctype="multipart/form-data" method=post onSubmit="return validar(this)"><table width="100%" align="left" border="0">
                              ...
                              color="#000000" size="1">
                                    ...
                                    <span class="style2">  </span> * <span class="style2">N&uacute;mero: </span>
