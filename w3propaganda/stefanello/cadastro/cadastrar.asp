...
comando = "INSERT INTO clientes (email, senha, codigo, nome, nofantasia, endereco, numero, complemento, bairro, cidade, estado, cep, cnpj, pessoa, inestadual, identidade, nomepai, nomemae, telefone, fax, celular, pecontato, email2, homepage, produtor, nascimento, datacadastro, limite, vendedor, banco, agencia, conta, msg, data, hora, foto, status, pais, nocliente, datacad, tel, cpf, rg)" & "VALUES('" & email & "','" & senha & "','" & codigo & "','" & nome & "','" & nofantasia & "','" & endereco & "','" & numero & "','" & complemento & "','" & bairro & "','" & cidade & "','" & estado & "','" & cep & "','" & cnpj & "','" & pessoa & "','" & inestadual & "','" & identidade & "','" & nomepai & "','" & nomemae & "','" & telefone & "','" & fax & "','" & celular & "','" & pecontato & "','" & email2 & "','" & homepage & "','" & produtor & "','" & nascimento & "','" & datacadastro & "','" & limite & "','" & vendedor & "','" & banco & "','" & agencia & "','" & conta & "','" & msg & "','" & g& "','" & h& "','" & cfoto& "', 'Ativo', 'Brasil', 'Vazio','" & g& "', '" & telefone & "', '" & cnpj & "', '" & nome & "')"
