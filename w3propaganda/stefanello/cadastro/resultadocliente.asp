...
strSql = "SELECT * FROM representantes WHERE nocliente LIKE '%"&Busca&"%'" 
...
%>
&nbsp;<a class=home_titulo1000 href="deletar.asp?codigo=<%=objRS("codigo")%>"><img alt="Apagar Representante" border="0" src="deletar.gif"></a>&nbsp;<img src="carinha2.gif">&nbsp;<a class=home_titulo1000 href="cliperfil.asp?codigo=<%=objRS("Codigo")%>"><%=objRS(TiraAspas("codigo"))%> - <%=objRS(TiraAspas("nocliente"))%></a><br>
<%
objRS.MoveNext
Loop
End IF
