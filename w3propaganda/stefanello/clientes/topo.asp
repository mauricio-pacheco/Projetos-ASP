...
<body bgcolor="<%=application("corfundo")%>" topmargin=0 leftmargin=0 marginwidth=0 marginheight=0 text=<%=cor4%>>
...
link = "formaspagamento.asp"
	...
	<basefont face="<%=fonte%>">
			  <table border="0" width="778" bgcolor=#ffffff cellpadding="1" cellspacing="1">
			  		 <tr><td valign="bottom" nowrap>&nbsp;&nbsp;<img src="<%=dirlingua%>/imagens/logo.gif"  border="0"></td>
					 		 <td valign="bottom" nowrap align="right"><table><tr><td valign=center><img src=<%=dirlingua%>/imagens/carrinho.gif border=0></td>
							 <td valign=top>
...
precito1 = formatNumber(intTotal,2)%>     
		 <table onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg1%>';return true;"><tr><td bgcolor=<%=corborda%>>
		   		<table width="100%">
					   ...
					   <tr><td bgcolor=<%=cor3%>><font face="<%=fonte%>" style=font-size:11px;  color=#000000>&nbsp;<%=strLg2%>&nbsp;</td>
					    	   <td align="right" valign="center" bgcolor=<%=cor3%>><font face="<%=fonte%>" style=font-size:11px;  color=#000000>&nbsp;<%=intQuantx%>&nbsp;</font></td></tr>
	             </table></td></tr>
	    </table></td></tr></table></a>
<%end if%>
	  	  </td></tr></table>
...
<%end if%>
		...
		<div id="layer1" style="position:absolute; top:102px; z-index:5"><table border=0 cellspacing=0 width=775 bgcolor=#ffffff cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor="bcbcbc" align=left></td></tr><tr><td height=5></td></tr></table></div>
		<div id="layer1" style="position:absolute; top:107px; z-index:7"><table border=0 cellspacing=0 width=775 cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor="bcbcbc" align=left></td></tr><tr><td height=5></td></tr></table></div>
		<div id="layer1" style="position:absolute; top:113px; width:100px; height:15px; z-index:8"><table border="0" cellspacing="0" cellpadding="0" width="163"><tr bgcolor="<%=cor3%>"><td bgcolor="<%=cor3%>" width=25><img src="<%=dirlingua%>/imagens/menu_1.gif" border="0"></td><td bgcolor="<%=cor3%>"><font style=font-size:11px;font-family:<%=fonte%>; color=000000><b><%=UCASE(strLg12)%></b></td></tr></table></div>
		<div id="layer1" style="position:absolute; top:113px; z-index:1">
			 <table border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" width="775"><tr><td width="128" valign="top" align="center">
			 		<table border="0" cellspacing="4" cellpadding="4" width="125">
					   ...
					   <tr><td width="128" bgcolor="#ffffff"><font face="<%=fonte%>" color="<%=cor4%>" style=font-size:11px><a href="como.asp" style="text-decoration:none;" onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg16%>';return true;"><B><img src=<%=dirlingua%>/imagens/flecha.gif border=0>&nbsp;&nbsp;<%=strLg16%></B></a></td></tr>					   <tr><td width="128" bgcolor="#ffffff"><font face="<%=fonte%>" color="<%=cor4%>" style=font-size:11px><a href="seguranca.asp" style="text-decoration:none;" onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg22%>';return true;"><B><img src=<%=dirlingua%>/imagens/flecha.gif border=0>&nbsp;&nbsp;<%=strLg22%></B></a></td></tr>
		 <tr><td><div id="layer1" style="position:absolute; left:0px; width: 300px;">
		 			  <table border="0" cellspacing="0" cellpadding="0" width="163"><tr><td bgcolor="<%=cor3%>" width=20><img src="<%=dirlingua%>/imagens/menu_2.gif" border="0"></td><td bgcolor="<%=cor3%>"><font style=font-size:11px;font-family:<%=fonte%> color=000000><b>&nbsp;<%=UCASE(strLg13)%></b></font></td></tr></table></td></tr></div>
					  		 <tr><td height=27></td></tr><tr><td><font style=font-style:11px><form action=pesquisa.asp method=get>
									 ...
									 <select name=cat style=font-size:11px;font-family:<%=fonte%> disabled>
									 <option value=todos>Nome do Produto&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
									 	</select></font>

	<div align=center>
		 <input type=submit value='PESQUISAR' class=texto></div></td></tr></form><tr><td><font style=font-style:11px><form action=pesquisa2.asp method=get>
							 		 <input type=text name=pesq  size=25 style=font-size:11px;font-family:<%=fonte%>;><br>
									 <select name=cat style=font-size:11px;font-family:<%=fonte%> disabled>
									 <option value=todos>Código do Produto&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
									 	</select></font>

	<div align=center>
		 <input type=submit value='PESQUISAR' class=texto></div></td></tr></form><tr><td>&nbsp;</td></tr>
					   <tr><td></td></tr>
					   <tr><td height="20" width="128" bgcolor="#ffffff"><font style=font-size:2px;>&nbsp;</font></td></tr>
