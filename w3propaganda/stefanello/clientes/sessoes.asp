...
<td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%></b><br><br><b>Código:</b> <%=rs("fabricante")%></td></form></tr></table>
</td></tr></table>
</td></tr></table>
