...
strTextoHtml = strTextoHtml & "Copyright(c) Mauricio Pacheco" & vbNewLine
...
strTextoHtml = strTextoHtml & "<TD><FONT face=tahoma style=font-size:11px><B>REPRESENTANTES</B></FONT></TD></TR>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2 height=2></td></td>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""?link=produtos&acao=inserir&acaba=sim"">Inserir Representantes</A></FONT></TD></TR>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""?link=clientes&acao=ver&acaba=sim"">Excluir Representantes</A></FONT></TD></TR>"
...
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""?link=compras&acao=ver&acaba=sim&dia=" & Day(Now) & "&mes=" & Month(Now) & "&ano=" & Year(Now) & "&data=" & dataz & """>Administrar Compras</A></FONT></TD></TR>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2 height=4></td></td>"
...
strTextoHtml = strTextoHtml & "<FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;A loja possui <b>" & contacli("totalcli") & "</b> representantes cadastrados.<br>"
...
Case 0
Case Else
Response.Write "<title>Cadastro Efetuado!</title><center><br><br><font face=tahoma style=font-size:12px><h1>Representante Cadastrado com Sucesso!</h1><br><rr><a href=""administrador.asp?"">Voltar para a Administração</a>"
End Select
else
Response.Write strTextoHtml
end if
...
strTextoHtml = strTextoHtml & "<BR><FONT face=tahoma color=#003366 style=font-size:17px><img src=""adm_imagens/cli_g.gif"" hspace=""1"" vspace=""1"" border=""0"" align=""left""><B>&nbsp;Administrar Representantes</B></FONT><hr size=1 color=#cccccc>"
...
strTextoHtml = strTextoHtml & "<font face=tahoma style=font-size:11px;color:000000>Representante(s) encontrado(s): <b>0" & totalreg & "</b> <hr size=1 color=#dddddd width=""100%"">"
...
strTextoHtml = strTextoHtml & "<td align=center><font face=""tahoma"" style=font-size:11px;color:000000><center>Para uma busca mais detalhada dos clientes cadastrados na loja realize uma pesquisa com o nome e/ou palavra-chave do representante  que você procura.</td><tr><td align=center>"
...
strTextoHtml = strTextoHtml & "<tr><td align=center><br><br><b><font style=font-size:11px>Nenhum representante foi encontrado na base de dados da loja.<br><br></b><br><br></td></tr></table>"
...
strTextoHtml = strTextoHtml & "<table><tr><td align=""left"" valign=""top""><table border=""0"" cellspacing=""4"" cellpadding=""4"" width=100><tr><td>"
strTextoHtml = strTextoHtml & "<font face=""tahoma"" style=font-size:11px;color:000000>Representante(s) encontrado(s): <b>" & totalreg & "</b> <hr size=1 color=#dddddd width=""100%"">"
strTextoHtml = strTextoHtml & "<table cellspacing=""3"" cellpadding=""3"" align=center width=""100%"">"
strTextoHtml = strTextoHtml & "<tr><form action=""?"" method=get><input name=""link"" type=""hidden"" value=""clientes""><input name=""acao"" type=""hidden"" value=""ver"">"
strTextoHtml = strTextoHtml & "<td align=center><font face=""tahoma"" style=font-size:11px;color:000000><center>Para uma busca mais detalhada dos representantes cadastrados na loja realize uma pesquisa com o nome e/ou palavra-chave do representante que você procura.</td><tr><td align=center>"
strTextoHtml = strTextoHtml & "<input name=""pesqsa"" type=""text"" size=30 value=""" & Request("pesqsa") & """ style=font-size:11px;color:000000;font-family:tahoma><font style=font-size:11px></font> <input type=submit class=""ok"" value=""Pesquisar"" style=font-size:11px;color:000000;font-family:tahoma>"
strTextoHtml = strTextoHtml & "<br><br></td></form></tr><tr><td height=1 bgcolor=cccccc></td></tr></table>"

If Request("status") = "sucesso" Then
strTextoHtml = strTextoHtml & "<br><center><b><font style=font-size:11px;font-family:tahoma;color:#003366>REPRESENTANTE EXCLUÍDO COM SUCESSO!<br><br></font></b></center>"
Else
...
strTextoHtml = strTextoHtml & "if (confirm('Você realmente deseja excluir este representante?'))" & vbNewLine
strTextoHtml = strTextoHtml & "{" & vbNewLine
...
strTextoHtml = strTextoHtml & "<table width=""100%"" bgcolor=#eeeeee style=""border-right: 1px solid #cccccc;border-top: 1px solid #cccccc;border-left: 1px solid #cccccc;border-bottom: 1px solid #cccccc;""><tr><td valign=center><font face=""tahoma"" style=font-size:11px;color:000000>" & iz & ") <b>" & UCASE(Cripto(rs("nome"),False)) & "</b><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data do cadastro: <b>" & rs("datacad") & "</b> &nbsp;&nbsp;&nbsp;Usuário: <b>" & varestoq & "</b></td><td align=right valign=center><font face=""tahoma"" style=font-size:11px;color:000000>Ação: <b><b><a href=""javascript: cli" & rs("clienteid") & "();"">Excluir</a></b>&nbsp;</td></tr></table> <table><tr><td height=4></td></tr></table>"
...
strTextoHtml = strTextoHtml & "<tr><td  bgcolor=#eeeeee><font style=font-family:tahoma;font-size:11px;color:#000000;>Estado:</font></td><td  bgcolor=#eeeeee><font style=font-family:tahoma;font-size:11px;color:#000000;><b>" & strEstado & "</td></tr>"
...
strTextoHtml = strTextoHtml & "<hr size=1 color=ffffff>"
strTextoHtml = strTextoHtml & "<hr size=1 color=cccccc>"
strTextoHtml = strTextoHtml & "<FONT face=tahoma color=#000000 style=font-size:11px>Compra efetuada pelo representante: <b>" & UCase(Cripto(rs3("nome"),false)) & "</b><br>"
...
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma color=#000000 style=font-size:11px>Estado: </b></td><td> <FONT face=tahoma color=#b23c04 style=font-size:11px><b>" & Cripto(rs("estadoentrega"),false) & "</b></td></tr>"
...
strTextoHtml = strTextoHtml & "<tr><td bgcolor=#eeeeee><br><FONT face=tahoma color=#000000 style=font-size:11px>Mensagem de OBS: </b><br><br></td><td bgcolor=#eeeeee> <br><FONT face=tahoma color=#b23c04 style=font-size:11px><b>" & Cripto(rs("msgpresente"),false) & "</b><br></td></tr>"

strTextoHtml = strTextoHtml & "</table><br>"
strTextoHtml = strTextoHtml & "<b>DADOS DA COMPRA E PAGAMENTO:</b><hr size=1 color=000000>"
strTextoHtml = strTextoHtml & "<table width=""100%"">"
strTextoHtml = strTextoHtml & "</form><tr><td bgcolor=003366><font face=tahoma style=font-size:11px;color:ffffff>&nbsp;Código</b></td>"
strTextoHtml = strTextoHtml & "<td bgcolor=003366><font face=tahoma style=font-size:11px;color:ffffff>&nbsp;Produto</b></td>"
strTextoHtml = strTextoHtml & "<td bgcolor=003366><font face=tahoma style=font-size:11px;color:ffffff>&nbsp;Unidade</b></td>"
...
strTextoHtml = strTextoHtml & "<hr size=1 color=ffffff>"
strTextoHtml = strTextoHtml & "<hr size=1 color=cccccc>"
strTextoHtml = strTextoHtml & "<FONT face=tahoma color=#000000 style=font-size:11px>Compra efetuada pelo representante: <b><a href=""?link=clientes&acao=olhar&cli=" & rs3("clienteid") & """>" & Cripto(rs3("nome"),False) & "</a></b><br>"
...
strTextoHtml = strTextoHtml & "</table><hr size=1 color=cccccc width=""100%""><table width=""100%""><tr><td><font face=tahoma style=font-size:11px;color:000000>Total da Compra</td><td align=right><font face=tahoma style=font-size:11px;color:000000><b>R$ " & totalcomprazw & "</b></td>"
strTextoHtml = strTextoHtml & "</tr></table>"
strTextoHtml = strTextoHtml & ""
strTextoHtml = strTextoHtml & ""
strTextoHtml = strTextoHtml & "<hr size=1 color=cccccc width=""100%""><table width=""100%""><tr><td><font face=tahoma style=font-size:11px;color:000000>Forma de Pagamento</td><td align=right><font face=tahoma style=font-size:11px;color:b23c04><b>" & ver & "</b></td></tr>" & strInf
strTextoHtml = strTextoHtml & "<tr><td><font face=tahoma style=font-size:11px;color:000000>Status</td><td align=right><font face=tahoma style=font-size:11px;color:000000><b>" & ver2 & "</b></td></tr></table>"
strTextoHtml = strTextoHtml & "<center><br><hr size=1 color=dddddd><center><FONT face=tahoma  style=font-size:11px><b><A href=""?&acaba=sim"">Voltar para página inicial</a></b></center><br>"
...
Select Case strAcao
Case "inserir"
strTextoHtml = strTextoHtml & "<BR><FONT face=tahoma color=#003366 style=font-size:17px><img src=""adm_imagens/prod_g.gif"" width=""30"" height=""33"" hspace=""1"" vspace=""1"" border=""0"" align=""left""><B>&nbsp;Incluir novo Representante</B></FONT><hr size=1 color=#cccccc>"
...
strTextoHtml = strTextoHtml & "<tr><td width=""40%""><FONT face=tahoma  style=font-size:11px><b>Usuário:</b></td><td><input name=""email"" type=""text"" value="""" size=20  style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td width=""40%""><FONT face=tahoma  style=font-size:11px><b>Senha:</b></td><td><input name=""senha"" type=""password"" value="""" size=20  style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td width=""40%""><FONT face=tahoma  style=font-size:11px><b>Representante:</b></td><td><input name=""nome"" type=""text"" value="""" size=75  style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Endereço:</b></td><td><FONT face=tahoma  style=font-size:11px><input name=""endereco"" type=""text"" size=60 value="""" style=font-size:11px;font-family:tahoma></td</tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Número:</b></td><td><FONT face=tahoma  style=font-size:11px><input name=""numero"" type=""text"" size=10 value="""" style=font-size:11px;font-family:tahoma>"
strTextoHtml = strTextoHtml & "</td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Bairro:</b></td><td><FONT face=tahoma  style=font-size:11px><input name=""bairro"" type=""text"" size=15 value="""" style=font-size:11px;font-family:tahoma>"
strTextoHtml = strTextoHtml & "</td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Cidade:</b></td><td><input name=""cidade"" type=""text"" size=24 value="""" style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Estado:</b></td><td><select class=""texto"" name=""estado""><option value=""estado"" selected=""selected"">Estado</option><option value=""AC - Acre"">AC - Acre</option><option value=""AL - Alagoas"">AL - Alagoas</option><option value=""AM - Amazonas"">AM - Amazonas</option><option value=""AP - Amap&aacute;"">AP - Amap&aacute;</option><option value=""BA - Bahia"">BA - Bahia</option><option value=""CE - Cear&aacute;"">CE - Cear&aacute;</option><option value=""DF - Distrito Federal"">DF - Distrito Federal</option><option value=""ES - Esp&iacute;rito Santo"">ES - Esp&iacute;rito Santo</option><option value=""GO - Goi&aacute;s"">GO - Goi&aacute;s</option><option value=""MA - Maranh&atilde;o"">MA - Maranh&atilde;o</option><option value=""MG - Minas Gerais"">MG - Minas Gerais</option><option value=""MS - Mato Grosso do Sul"">MS - Mato Grosso do Sul</option><option value=""MT - Mato Grosso"">MT - Mato Grosso</option><option value=""PA - Par&aacute;"">PA - Par&aacute;</option><option value=""PB - Para&iacute;ba"">PB - Para&iacute;ba</option><option value=""PE - Pernambuco"">PE - Pernambuco</option><option value=""PI - Piau&iacute;"">PI - Piau&iacute;</option><option value=""PR - Paran&aacute;"">PR - Paran&aacute;</option><option value=""RJ - Rio de Janeiro"">RJ - Rio de Janeiro</option><option value=""RN - Rio Grande do Norte"">RN - Rio Grande do Norte</option><option value=""RO - Roraima"">RO - Roraima</option><option value=""RR - Roraima"">RR - Roraima</option><option value=""RS - Rio Grande do Sul"">RS - Rio Grande do Sul</option><option value=""SC - Santa Catarina"">SC - Santa Catarina</option><option value=""SE - Sergipe"">SE - Sergipe</option><option value=""SP - S&atilde;o Paulo"">SP - S&atilde;o Paulo</option><option value=""TO - Tocantins"">TO - Tocantins</option></select></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>CEP:</b></td><td><input name=""cep"" type=""text"" size=20 value="""" style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>CNPJ / CPF:</b></td><td><input name=""cnpj"" type=""text"" size=30 value="""" style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Telefone:</b></td><td><input name=""telefone"" type=""text"" size=25 value="""" style=font-size:11px;font-family:tahoma></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td></td></tr>"
strTextoHtml = strTextoHtml & "<tr><td align=center></td><td align=center>&nbsp;&nbsp;&nbsp;&nbsp;<input type=""submit"" NAME=""Enter"" style=font-size:11px;font-family:tahoma value="" Enviar representante ""> <input type=""reset"" value=""Limpar formulario"" style=font-size:11px;font-family:tahoma></td></table><br><hr size=1 color=dddddd><center><FONT face=tahoma  style=font-size:11px><b><A href=""?&acaba=sim"">Voltar para página inicial</a></b></center><br></form>"
...
textosql = "INSERT INTO clientes (email, senha, nome, endereco, numero, bairro, cidade, estado, cep, cnpj, telefone, datacadastro, data, hora, status, datacad, tel, cpf, rg)" & "VALUES('" & email & "','" & senha & "','" & nome & "','" & endereco & "','" & numero & "','" & bairro & "','" & cidade & "','" & estado & "','" & cep & "','" & cnpj & "','" & telefone & "','" & g & "','" & g & "', '" & h & "', 'Ativo', '" & g& "', '" & telefone & "', '" & cnpj & "', '" & nome & "')"
...
strTextoHtml = strTextoHtml & "<BR><FONT face=tahoma color=#003366 style=font-size:17px><img src=""adm_imagens/prod_g.gif"" width=""30"" height=""33"" hspace=""1"" vspace=""1"" border=""0"" align=""left""><B>&nbsp;Excluir Representantes</B></FONT><hr size=1 color=#cccccc>"
strTextoHtml = strTextoHtml & "<table><tr><td align=""left"" valign=""top""><table border=""0"" cellspacing=""4"" cellpadding=""4"" width=100><tr><td>"
strTextoHtml = strTextoHtml & "<font face=""tahoma"" style=font-size:11px;color:000000>Produtos(s) encontrado(s): <b>" & totalreg & "</b> <hr size=1 color=#dddddd width=""100%"">"
strTextoHtml = strTextoHtml & "<table cellspacing=""3"" cellpadding=""3"" align=center width=""100%"">"
strTextoHtml = strTextoHtml & "<tr><form action=""?"" method=get><input name=""link"" type=""hidden"" value=""produtos""><input name=""acao"" type=""hidden"" value=""excluir"">"
