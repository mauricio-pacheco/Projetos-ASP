...
%>
					...
					<table border="0" cellpadding="1" cellspacing="1" width="96%" align=center>
						   ...
						   <tr><td><font style=font-family:<%=fonte%>;font-size:11px;color:#808080;><%=strLg81%></td><td><select style=font-family:<%=fonte%>;font-size:11px;color:#000000; name="estado">
                           <option 
                                value="<%= request.querystring("estado") %>"><%= request.querystring("estado") %></option>
                           <option 
                                ...
                                value="SE - Sergipe">SE - Sergipe</option>
                                      ...
                                      <option 
                                value="TO - Tocantins">TO - Tocantins</option></select><font face="<%=fonte%>" style=font-family:<%=fonte%>;font-size:11px;color:#000000;></td></tr>
