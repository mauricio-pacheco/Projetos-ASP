...
%>
&nbsp;<a class=home_titulo1000 href="deletar.asp?id=<%=objRS("id")%>"><img alt="Apagar Representante" border="0" src="deletar.gif"></a>&nbsp;<img src="carinha2.gif">&nbsp;<a class=home_titulo1000 href="cliperfil.asp?id=<%=objRS("id")%>"><%=objRS(TiraAspas("codigo"))%> - <%=objRS(TiraAspas("nocliente"))%></a><br>
<%
objRS.MoveNext
Loop
End IF
