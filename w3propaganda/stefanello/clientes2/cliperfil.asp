                        ...
                        width="100%" border=0>
                          ...
                          <TR>
                            <TD align=middle><table width="100%" border="0">
                              ...
                              <tr>
                                <td width="83%" class="style2" style="font-size: 12px">Perfil de: <span style="color: #FF0000"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("nocliente")%></font></span></td>
                          ...
                          <TR>
                            <TD vAlign=top width="60%"><FORM name=cadastro action=cadastrar.asp method=post onSubmit="return validar(this)"><table width="100%" align="left" border="0">
                              <tbody>
                                ...
                                <tr>
                                  <td class="style2"><span style="color: #0066CC"><span class="style2">Usu&aacute;rio: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("usuario")%></font></span></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                  <td><table width="32%" border="0" align="center">
                                    <tr>
                                      ...
                                      <td class="style2"><div align="center"><a class=home_titulo1000 href="deletar.asp?codigo=<%=rs("Codigo")%>">DELETAR REPRESENTANTE</a></div></td>
                                      </tr>
                                  </table></td>
                                </tr>
                              </tbody>
