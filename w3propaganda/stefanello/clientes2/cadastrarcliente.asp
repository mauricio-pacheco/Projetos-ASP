                          ...
                          <TR>
                            <TD width="60%" vAlign=top class="style2" style="font-size: 12px"><table width="100%" align="left" border="0">
                              <tbody>
                                ...
                                <tr>
                                  <td class="style2" style="color: #0033FF"><span class="style2">Usu&aacute;rio Respons&aacute;vel: </font></td>
                                </tr>
                                <tr>
                              ...
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color="#000000" size="1">
                                    <input class="texto" size="26" name="cidade" />
                                  </font></td>
                                </tr>
                                <tr>
                              ...
                              name="estado">
                                ...
                                <tr>
                                  <td class="style2"><span class="style2">CEP:</font></td>
                                </tr>
                                <tr>
                                  <td class="style2"><font 
                              face="Verdana, Arial, Helvetica, sans-serif" 
