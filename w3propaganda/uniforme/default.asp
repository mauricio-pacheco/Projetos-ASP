      ...
      <td><table width="100%" border="0">
        <tr>
          ...
          <td width="75%"><table width="100%" border="0">
            <tr>
              <td><img src="icone.gif" width="14" height="14"> <span style="font-size: 10px; color: #0D7A29; font-family: Verdana, Arial, Helvetica, sans-serif">Home</span><br>
                  <hr></td>
            </tr>
          </table>
            ...
            <tr>
              <td><div align="center" style="font-size: 12px"></div></td>
              <td><div align="center" style="font-size: 12px"></div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
