...
cellSpacing=0 bgColor=#ffffff class=texto style="BORDER-RIGHT: gainsboro 1px solid" style="BORDER-LEFT: gainsboro 1px solid"></HTML>
  ...
  <TR>
    <TD bgColor=#005DA2 colSpan=3 height=25><TABLE class=texto cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR vAlign=center>
          <TD width="100%" bgcolor="#005DA2"><div align="center"><FONT color=#ffffff><span class="style2">&nbsp;&nbsp;Cadastro de Representantes -
              ...
              <TR>
                <TD vAlign=top>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD vAlign=top width="1%"><TABLE class=texto cellSpacing=5 cellPadding=0 
                        width="100%" align=center border=0>
                          <TBODY>
                          <TR>
                            <TD vAlign=top width="60%"><FORM name=login action=logarcliente.asp method=post><table width="100%" align="left" border="0">
                              <tbody>
                                <tr>
                                  <td class="style2"><div align="center" style="font-size: 12px">Digite o Usu&aacute;rio e a Senha abaixo para acessar a &aacute;rea restrita para Representantes:</div></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><div align="center" style="color: #FF0000">Usu&aacute;rio ou Senha inv&aacute;lidos</div></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><div align="center">Usu&aacute;rio:</div></td>
                                </tr>
                                <tr>
                                  <td class="style2"><div align="center"><font 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color="#000000" size="1">
                                    <input class="texto" size="20" name="usuario" id="usuario" />
                                  </font></div></td>
                                </tr>
                                <tr>
                                  <td class="style2"><div align="center">Senha:</div></td>
                                </tr>
                                <tr>
                                  <td class="style2"><div align="center"><font 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color="#000000" size="1">
                                ...
                                <tr>
                                  <td width="68%"><div align="center"><font 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color="#000000" size="1">
                                    <input class="texto" type="reset" value="Limpar" name="limpar" />
                                    <input class="texto" type="submit" value="Efetuar Login" name="submit"/>
                                  </font></div></td>
                                </tr>
                              </tbody>
                            </table>
