                          ...
                          <TR>
                            <TD vAlign=top width="60%"><FORM name=cadastro action=cadastrar.asp method=post onSubmit="return validar(this)"><table width="100%" align="left" border="0">
                              <tbody>
                                ...
                                <tr>
                                  <td width="68%" class="style2"><span class="style2">C&oacute;digo do Cliente: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("cod")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">Nome do Cliente: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("cliente")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">Raz&atilde;o Social: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("razaosocial")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">Nome Fantasia ou Nome Auxiliar:</font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <%=rs("nomefantasia")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                  <td class="style2"><span class="style2">Complemento de Endere&ccedil;o: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("complend")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                  <td class="style2"><span class="style2">Cidade: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("cidade")%> -<font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("estado")%></font></font></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">CEP: </font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("cep")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">CNPJ / CPF:
                                      <font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("cnpjcpf")%></font></span></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">Inscri&ccedil;&atilde;o Estadual:</font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <%=rs("ie")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">Identidade:</font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <%=rs("ci")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td class="style2"><span class="style2">Data Nascimento:</font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <%=rs("datanasc")%></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                  <td class="style2"><span class="style2">E-mail:</font><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <a class=home_titulo1000 href="mailto:<%=rs("email")%>"><%=rs("email")%></a></font></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                  <td class="style2"><table width="400" border="0">
                                    <tr>
                                      <td><font color="#005DA2" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("observacao")%></font></td>
                                    </tr>
                                  </table></td>
                                </tr>
                                <tr>
