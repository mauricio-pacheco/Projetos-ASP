                        ...
                        width="100%" align=center border=0>
                          ...
                          <TR>
							...
							Do While NOT rs.EOF %>
	                          ...
	                          &nbsp;<a class=home_titulo1000 href="deletar.asp?clienteid=<%=rs("clienteid")%>"><img alt="Apagar Representante" border="0" src="deletar.gif"></a>&nbsp;<img src="carinha2.gif">&nbsp;<a class=home_titulo1000 href="cliperfil.asp?clienteid=<%=rs("clienteid")%>"><%=rs("nome")%></a>&nbsp;<br>
