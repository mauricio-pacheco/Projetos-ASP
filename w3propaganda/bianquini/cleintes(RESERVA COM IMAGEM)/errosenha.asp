...
cellSpacing=0 bgColor=#ffffff class=texto style="BORDER-RIGHT: gainsboro 1px solid" style="BORDER-LEFT: gainsboro 1px solid"></HTML>
  ...
  <TR>
    <TD bgColor=#005DA2 colSpan=3 height=25><TABLE class=texto cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR vAlign=center>
          <TD width="70%" bgcolor="#005DA2"><FONT color=#ffffff><span class="style2">&nbsp;&nbsp;Cadastro de Representantes - <script language="JavaScript">
...
//--->
          ...
          <TD width="20%" align=right bgcolor="#005DA2"></TD></TR></TBODY></TABLE></TD>
  <TR>
  <TR>
    <TD vAlign=top>
                    ...
                    <TR>
                      <TD vAlign=top width="1%"><TABLE class=texto cellSpacing=0 cellPadding=4 
                        width="100%" border=0>
                          <TBODY>
                          <TR>
                            <TD align=middle><div align="left"><span style="font-size: 12px">&Aacute;rea Exclusiva</span></div></TD>
                          </TR></TBODY></TABLE>
                          ...
                          <TR>
                            <TD vAlign=top width="60%"><FORM name=login action=logar.asp method=post><table width="100%" align="left" border="0">
                              <tbody>
                                ...
                                <tr>
                                  <td class="style2"><div align="center"><span style="font-size: 12px">Digite o Usu&aacute;rio e a Senha abaixo para acessar a &aacute;rea restrita:</span></div></td>
                                </tr>
                                <tr>
                                  <td class="style2">&nbsp;</td>
                                </tr>
