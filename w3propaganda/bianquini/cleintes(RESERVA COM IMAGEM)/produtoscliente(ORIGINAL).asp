      ...
      Loop
                          ...
                          <TR>
                            <TD vAlign=top class="style2" style="font-size: 12px"><span class="style2" style="font-size: 12px"><span class="style2" style="font-size: 10px; color: #000000">Formas de Pagamento:</span></font><font 
                              ...
                              <select class="texto" 
                              name="clientetotal2">
                                <option value="formas">Á vista</option>
                                <option value="formas">Cartão de Crédito</option>
                                <option value="formas">Crediário</option>
                                <option value="formas">Boleto Bancário</option>
