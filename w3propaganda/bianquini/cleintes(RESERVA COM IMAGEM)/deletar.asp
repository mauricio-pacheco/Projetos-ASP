...
<META HTTP-EQUIV="Refresh" CONTENT="2;URL=clientes.asp">  
                        ...
                        width="100%" border=0>
                          ...
                          <TR>
                            <TD align=middle><table width="100%" border="0">
                              ...
                              <tr>
                                <td width="83%" class="style2" style="font-size: 12px">Cadastro de Representantes<span style="color: #FF0000"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"></font></span></td>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td><div align="center">
                                    ...
                                    <p style="font-size: 12px">O Representante foi exclu&iacute;do com sucesso!</p>
