...
strTextoHtml = strTextoHtml & "<br><b>DADOS DO REPRESENTANTE:</b><hr size=1 color=000000>"
strTextoHtml = strTextoHtml & "<table width=""100%"">"
...
strTextoHtml = strTextoHtml & "<td bgcolor=003366><font face=tahoma style=font-size:11px;color:ffffff>&nbsp;Quantidade</b></td>"
...
strTextoHtml = strTextoHtml & "<hr size=1 color=ffffff>"
strTextoHtml = strTextoHtml & "<hr size=1 color=cccccc>"
strTextoHtml = strTextoHtml & "<FONT face=tahoma color=#000000 style=font-size:11px>Compra efetuada pelo representante: <b>" & Cripto(rs3("nome"),False) & "</b><br>"
...
strTextoHtml = strTextoHtml & "<br><b>DADOS DO REPRESENTANTE:</b><hr size=1 color=000000><table width=""100%"">"
strTextoHtml = strTextoHtml & "<tr><td bgcolor=#eeeeee><FONT face=tahoma color=#000000 style=font-size:11px>Data da compra: </b></td><td  bgcolor=#eeeeee> <FONT face=tahoma color=#b23c04 style=font-size:11px><b>" & rs("datacompra") & "</b></td></tr>"
...
textosql = "INSERT INTO clientes (pais, email, senha, nome, endereco, numero, bairro, cidade, estado, cep, cnpj, telefone, datacadastro, data, hora, status, datacad, tel, cpf, rg)" & "VALUES('Brasil', '" & email & "','" & senha & "','" & nome & "','" & endereco & "','" & numero & "','" & bairro & "','" & cidade & "','" & estado & "','" & cep & "','" & cnpj & "','" & telefone & "','" & g & "','" & g & "', '" & h & "', 'Ativo', '" & g& "', '" & telefone & "', '" & cnpj & "', '" & nome & "')"
