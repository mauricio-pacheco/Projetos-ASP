...
'*************************************
StringdeConexao = "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=bianq;pwd=w37001;Initial Catalog=bianquini;Data Source=mssql.moveisbianquini.com.br"
'*********************************
