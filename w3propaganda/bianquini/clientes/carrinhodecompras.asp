...
%>  
		   <font face="<%=fonte%>" style=font-size:13px><strong><%=strLg65%></strong></font></p><p><font face="<%=fonte%>" style=font-size:10px;color:000000><%=strLg56%><br><%=strLg57%></font></p><font face="<%=fonte%>" style=font-size:10px;color:red><%=request.querystring("erro")%></font><form action="atualizapedido.asp" method="post" name="registro1">
		   		 <table border="0" cellpadding="2" cellspacing="1" width="570" align=center>
				 	<tr bgcolor="<%=cor3%>"><td width="15%" align="left" valign="center" nowrap><font color="#000000" face="<%=fonte%>" style=font-size:11px;><strong><%=strLg58%><strong></font></strong></strong></td><td width="39%" align="left" valign="center" nowrap><font color="#000000" face="<%=fonte%>" style=font-size:11px;><strong><%=strLg59%><strong></font></strong></strong></td><td width="40%" align="right" valign="center" nowrap><font color="#000000" face="<%=fonte%>" style=font-size:11px;><strong><%=strLg61%><strong></font></strong></strong></td><td width="10%" align="right" valign="center" nowrap><font color="#000000" face="<%=fonte%>" style=font-size:11px;><strong><%=strLg62%><strong></font></strong></strong></td></tr>
<%
		 ...
		 <script LANGUAGE="JScript">
			...
			function HandleError<%= intProdID %>(eSrc){var val = parseInt(eSrc.value);
				...
				if (val <= 0) {
				 ...
				 <tr><td width="15%" valign="center" align="left"><font face="<%=fonte%>" size="2"> <input name="quant<%= intProdID %>" size="2" value="<%=intQuant%>" onChange="HandleError<%= intProdID %>(this)" style=font-size:11px;font-family:<%=fonte%>; maxlength=2></font></td><td width="39%" align="left"><font face="<%=fonte%>" style=font-size:11px;color:000000><b><%= strProdNome %></b></font></td><td width="40%" align="right"><font face="<%=fonte%>" style=font-size:11px;color:000000><%= strLgMoeda & " " & totpreco %></font></td><td width="10%" align="right"><center><a href="atualizapedido.asp?acao=remover&produto=<%= intProdID %>&frete=<%=estado2%>" onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg62%>';return true;"><img src=<%=dirlingua%>/imagens/del.gif border=0></a></td></tr>
<%pedidos.MoveNext
wend
pedidos.Close
set pedidos = Nothing
...
%>    
		  ...
		  <tr><td valign="center" align="left" colspan=3><font face="<%=fonte%>" style=font-size:11px;color:000000><strong><%=strLg63%><strong></font></strong></strong></td><td colspan="3" align="right" valign="center"><font face="<%=fonte%>" style=font-size:11px;color:000000><strong><b><%= strLgMoeda & " " & totaldasuacompra %></b><strong></font></strong></strong></td></tr><tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr><tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr><tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr><tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr><tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr><tr bgcolor=<%=cor3%>><td colspan=5 heigth=5></tr><tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr>
		  <!--#include file="frete.asp" -->
		  <tr bgcolor=""#ffffff""><td colspan=5 heigth=20></tr><tr bgcolor=<%=cor3%>><td colspan=5 heigth=5></td></tr>
