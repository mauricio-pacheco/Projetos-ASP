...
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma color=#FF0000 style=font-size:11px>CLIENTE SELECIONADO: </b></td><td> <FONT face=tahoma color=#1E732B style=font-size:11px><b>" & estadoz & "</b></td></tr>"
...
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Unidade:</b></td><td><FONT face=tahoma  style=font-size:11px><input name=""peso"" type=""text"" size=10 value="""
...
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Código:</b></td><td><input name=""fabri"" type=""text"" size=10 value="""
