    		  				     ...
    		  				     <table BORDER="0" CELLSPACING="1" CELLPADDING="0"><tr><td bgcolor=#bfbfbf>
    							 		<table BORDER="0" CELLSPACING="1" CELLPADDING="3"><tr><td bgcolor=#ffffff>
    										   <table align=center width=500 cellspacing="1" cellpadding="1">
    										   		  <tr><td valign=center width=400><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%></b><br><br><b>Preço:</b><%=strlgMoeda &" "& precito%><br><b>Estoque:</b> <%if rs("estoque") = "s" then response.write "Disponível" else response.write "Não disponível" end if%> para entrega</td><td valign=center><div align=right><br><a href="produtos.asp?produto=<%=rs("idprod")%>" onMouseOut="window.status='';return true;" onMouseOver="window.status='+ Detalhes';return true;" style="color:#FFFFFF;text-decoration:none;"><img src=<%=dirlingua%>/imagens/detalhes.gif border="0"></a></div></td></tr>
    										   </table>
    								    </table>
    						     </table>
    <%
...
<%else
	...
	%>
    		  				     <table BORDER="0" CELLSPACING="1" CELLPADDING="0"><tr><td bgcolor=#bfbfbf>
    							 		<table BORDER="0" CELLSPACING="1" CELLPADDING="3"><tr><td bgcolor=#ffffff>
    										   <table align=center width=500 cellspacing="1" cellpadding="1">
    										   		  <tr><td valign=center width=400><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%> </b><br><br><b>Preço:</b><%=strLgMoeda & " " & precito%><br><font color=#005500><b>Preço Parcelado:</b></font>&nbsp;<font color=#4074A6 size=2><b><%=rs("peso")%></b>&nbsp;<b>X</b></font>&nbsp;<font color=#E60000><%=strLgMoeda & " " & precitoparcelado%></font><br><b>Estoque:</b> <%if rs("estoque") = "s" then response.write "Disponível" else response.write "Não disponível" end if%> para entrega</td><td valign=center><div align=right><a href="produtos.asp?produto=<%=rs("idprod")%>" onMouseOut="window.status='';return true;" onMouseOver="window.status='+ Detalhes';return true;" style="color:#FFFFFF;text-decoration:none;"><img src="produtos/<%=rs("impeq")%>" border="0"></a><br>&nbsp;<%if rs.fields("promocao") = "b" then response.write " " & "" else if rs.fields("promocao") = "s" then response.write " " & "<img src='promo.gif'>" else if rs.fields("promocao") = "n" then response.write " " & "<img src='lancamento.gif'>" end if%><a href="produtos.asp?produto=<%=rs("idprod")%>" onMouseOut="window.status='';return true;" onMouseOver="window.status='+ Detalhes';return true;" style="color:#FFFFFF;text-decoration:none;"><img src=<%=dirlingua%>/imagens/detalhes.gif border="0"></a>&nbsp;&nbsp;</div></td></tr>
    										   </table>
    								    </table>
    						     </table>
    <%
    ...
    rs.MoveNext
    loop%>
    <table width=778><tr><td colspan=2><center><br>
    ...
    <tr><td colspan=2 align=center><table border=0 cellspacing=0 width=100% cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor=<%=cor3%>></td></tr><tr><td height=5></td></tr></table><center><a HREF="default.asp" style=text-decoration:none onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg41%>';return true;"><font face="tahoma,arial,helvetica" style=font-size:11px><img src="voltando.gif" border="0"></a></font></center></center></td></tr>
