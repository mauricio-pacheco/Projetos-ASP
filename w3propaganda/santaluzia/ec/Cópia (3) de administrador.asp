...
End If
strTextoHtml = strTextoHtml & "</td></tr>"
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Preço a Prazo:</b></td><td><FONT face=tahoma  style=font-size:11px><input name=""peso"" type=""text"" size=2 value="""" style=font-size:11px;font-family:tahoma>&nbsp;  X de&nbsp;R$ <input name=""precn"" type=""text"" size=15 value="""
...
& ", juro, aomes, estoque, promocao, idsessao, data, peso, imgra, impeq, status) VALUES ('" & nome & "', " _
...
strTextoHtml = strTextoHtml & "<tr><td><FONT face=tahoma  style=font-size:11px><b>Preço a Prazo:</b></td><td><FONT face=tahoma  style=font-size:11px>" & peso & "</b> X de <FONT face=tahoma  style=font-size:11px>R$ " & FormatNumber(precon, 2) & "</b></td></tr>"
...
textozql = "UPDATE produtos SET nome = '" & nome & "', fabricante = '" & fabricante & "', detalhe = '" & descricao & "', preco = '" & precon & "', precovelho =  '" & precov & "', parcela = '" & parcelamento & "', juro = '" & juros & "', aomes = '" & juropor & "' , estoque = '" & estoq & "', promocao = '" & promocao & "', idsessao = '" & categ & "', peso = '" & peso & "' WHERE idprod=" & UploadRequest.Item("prod").Item("Value") & ";"
