...
pasta = Server.MapPath("cabecalho/")
nome_foto = "/"&nome_foto

' pasta + nome dos arquivos
cfoto = "cabecalho" + nome_foto
...
' pasta onde as imagens serao guardadas
pasta2 = Server.MapPath("cabecalho/")
nome_foto2 = "/"&nome_foto2

' pasta + nome dos arquivos
cfoto2 = "cabecalho" + nome_foto2
...
' pasta onde as imagens serao guardadas
pasta3 = Server.MapPath("cabecalho/")
nome_foto3 = "/"&nome_foto3

' pasta + nome dos arquivos
cfoto3 = "cabecalho" + nome_foto3
...
comando = "UPDATE cima SET link1 = '" & link1 & "', link2 = '" & link2 & "', link3 = '" & link3 & "', foto1 = '" & cfoto & "', foto2 = '" & cfoto2 & "', foto3 = '" & cfoto3 & "' WHERE id = 6 "
