...
While Not menu.EOF%>
	  	  <tr>
        <td height="24" bordercolor="#A7D2EF" bgcolor="#F8F8F8" onClick="window.location='sessoes.asp?item=<%= menu("id") %>';" onMouseOver="this.style.backgroundColor='#DBEEF2'; this.style.color='#252525'; this.style.cursor='pointer'" onMouseOut="this.style.backgroundColor='#F8F8F8'; this.style.color='#252525';"><font face="<%=fonte%>" color="<%=cor4%>" style=font-size:11px><img src="bolinha.gif"> <%=menu("nome")%></font></td>
      </tr>
...
'Fecha o menu
menu.Close
Set menu = Nothing%>   <tr><td width="128" bgcolor="#ffffff"></td></tr><tr><td width="128" bgcolor="#ffffff"></td></tr></table></td><td width="1" bgcolor="<%=cor1%>" height=550><img src="espaco" width="1" height="1" alt border="0"></td><td align="left" valign="top"><table border="0" cellspacing="4" cellpadding="4"><tr><td>
