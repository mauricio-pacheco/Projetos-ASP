...
strTextoHtml = strTextoHtml & "<!--- PRODUTOS NA LOJA --->"
strTextoHtml = strTextoHtml & "<TR bgcolor=#eeeeee><TD><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/news.gif"" border=0></FONT></TD>"
strTextoHtml = strTextoHtml & "<TD><FONT face=tahoma style=font-size:11px><B>IMAGEM</B></FONT></TD></TR>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2 height=2></td></td>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""?link=produtos&acao=inseririmagem&acaba=sim"">Inserir imagem</A></FONT></TD></TR>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2 height=2></td></td>"
