	  	...
	  	<script language="javascript">
			function limpa () {
			 ...
			 document.registro1.duvida.value = '<%=strLg128%> <%=nomeloja%>?'
				 ...
				 <table><tr><td align="left" valign="top">
				 			<table border="0" cellspacing="4" cellpadding="4" width=810><tr><td><font face="<%=fonte%>" style=font-size:11px;color:000000> <a href=default.asp style=text-decoration:none; onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg4%>';return true;"><b><%=strLg4%></b></a> » Quem somos<br><br><div align=left> <hr size=1 color=<%=cor3%> width=100%>  </div>
				 			<p><font face="<%=fonte%>" style=font-size:13px><strong><br>
  Óptica Santa Luzia</strong></font> <font color=red size=1><font color="#4074A6"><%=request.querystring("erro")%></font>
  </p>
  <div align=center>
				 			  </p>
				 			<p><img src="loja2.jpg"></p>
				 			<p><img src="loja3.jpg"></p>
				 			<p><img src="loja.jpg"><br>
				 			  <br>
				 			  </p>
				 			<div align=left> <hr size=1 color=<%=cor3%> width=100%></div></FORM></td></tr>
							</table></td></tr>
				</table>
			<!-- #include file="baixo.asp" -->
<%end if%>
