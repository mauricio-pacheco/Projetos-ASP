...
strTextoHtml = strTextoHtml & "<FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;A loja possui <b>" & contacli("totalcli") & "</b> clientes cadastrados.<br>"
strTextoHtml = strTextoHtml & "<FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;Foram feitas <b>" & contacompra("totalcomp") & "</b> compras até o dia <b>" & dia & "/" & mez & "/" & Year(Date) & "</b>.<br></td></tr></table>"
