<% response.redirect "sessoes.asp?item=11" %>
<%
'#########################################################################################
'#----------------------------------------------------------------------------------------
'#########################################################################################
		 ...
		 <table width=100% cellspacing="3" cellpadding="1" align=right>
				...
				<table BORDER="0" CELLSPACING="1" CELLPADDING="0"><tr><td bgcolor=#bfbfbf>
					   <table BORDER="0" CELLSPACING="1" CELLPADDING="3"><tr><td bgcolor=#ffffff>
                              ...
                              <tr><td align=right colspan=2><table width="100%" border="0">
  <tr>
    <td width=2%><img src=<%=dirlingua%>/imagens/trofeu.gif border=0>&nbsp;</td>
    <td align=left width=98%><font face=<%=fonte%> style=font-size:11px;color:000000;><b>CAMPEÕES DE VENDA</b>&nbsp;</td>
  </tr>
</table>
</td></tr>
