...
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2 height=2></td></td>"
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""?link=util&acao=limpar&acaba=sim"">Limpar Compras em Aberto</A></FONT></TD></TR>"
...
strTextoHtml = strTextoHtml & "<tr><td bgcolor=#eeeeee><br><FONT face=tahoma color=#000000 style=font-size:11px>Complemento: </b><br><br></td><td bgcolor=#eeeeee> <FONT face=tahoma color=#b23c04 style=font-size:11px><b>" & rs("msgpresente") & "</b><br></td></tr>"
