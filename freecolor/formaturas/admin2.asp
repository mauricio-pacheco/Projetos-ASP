...
<HTML><HEAD><TITLE>Free Color</TITLE>
...
ID = request.form("ID")
    	...
    	DSNtemp=dsntemp & "DBQ=" & server.mappath("../free.mdb")
    	conn.Open DSNtemp
   ...
   %>
          <tr> 
            <td width="780" bgcolor="#FFFFFF"> <p><font color="#000000" size="1"> 
              ...
              <p><font color="#000000" size="1"><font color="#000000" size="1"><font face="Verdana">T&iacute;tulo </font></font></font><font color="#000000" size="1" face="Verdana">:</font><font color="#000000" size="1"><font face="Verdana">
              <% =titulo2%>
              </font></font></p>
