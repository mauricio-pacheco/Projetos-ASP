 ...
 * ============================================================================================== */
TransMenu.spacerGif = "/images/1pixtrans.gif";                     // path to a transparent spacer gif
TransMenu.dingbatOn = "/menu/expand-1.gif";            // path to the active sub menu dingbat
TransMenu.dingbatOff = "/menu/expand-1.gif";          // path to the inactive sub menu dingbat
...
TransMenu.shadowPng = "/menu/grey-40.png";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#000000";                   // color of the background (transparency set in CSS)
TransMenu.backgroundPng = "/menu/white-90.png";          // a PNG graphic to server as the background for mac IE5
