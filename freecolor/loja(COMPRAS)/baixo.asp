...
%>
	...
	<div id="layer1" style="position:absolute; z-index:8;background-color:ffffff; width: 775px;">
	  <table border=0 bgcolor=#ffffff cellpadding=0 cellspacing=0 width="775"><tr>
    <td height="20"  bgcolor="<%=cor2%>" width="100%"><font face="<%=fonte%>" style=font-size:11px;color:<%=fontebranca%>><b>&nbsp;&nbsp;&nbsp; 
