...
%>
    ...
    <td height="20"  bgcolor="<%=cor2%>" width="100%"><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font face="<%=fonte%>" style=font-size:11px;color:<%=fontebranca%>><b>&nbsp;&nbsp;&nbsp; 
          <%response.write "© Copyright 2005/"&year(now)&" - "&nomeloja&"&nbsp;"%> 
      - Desenvolvimento: <a href="http://www.casadaweb.net" target=_blank><font color="#ffffff">Casa da Web</font></a>
      <%
