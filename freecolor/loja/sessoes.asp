...
'Inicia a primeira coluna%>
  		  		<tr><td>
						...
						<table align=center width=260 cellspacing="1" cellpadding="1"><tr><td width=80 height=100><img src="produtos/<%=rs("impeq")%>" width="75" border="0"></td><td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%></b><br><br><b><%=strLg29%></b>&nbsp;<%= strlgMoeda & " " & precito%><br><b><%=strLg28%></b> <%if rs("estoque") = "s" then response.write strLg26 else response.write strLg27 end if%>&nbsp;<%=strLg25%><div align=right><br><input type="hidden" name="intProdID" value="<%= intProdID %>"><input type="hidden" name="intQuant" value=1><%if rs.fields("estoque") = "s" then response.write "" end if%><a href="produtos.asp?produto=<%=rs("idprod")%>"  onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg30%>';return true;" style="color:#FFFFFF;text-decoration:none;"><img src=<%=dirlingua%>/imagens/detalhes.gif border="0"></a></div></td></form></tr>
						</table></td></tr>
					    </table></td></tr>
				        </table></td></tr>
<%
...
'Formata o preco
precito2 = formatNumber(rs3("precovelho"),2)
'id do produto
...
%>
  		  		<tr><td>
					    ...
					    <table align=center width=260 cellspacing="1" cellpadding="1"><tr><td width=80 height=100><img src="produtos/<%=rs3("impeq")%>" width="75" border="0"></td><td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs3("nome")%></b><br><br><b><%=strLg29%></b>&nbsp;<%=strlgMoeda & " " & precito2%><br><b><%=strLg28%></b> <%if rs3("estoque") = "s" then response.write strLg26 else response.write strLg27 end if%>&nbsp;<%=strLg25%><div align=right><br><input type="hidden" name="intProdID" value="<%= intProdID2 %>"><input type="hidden" name="intQuant" value=1><%if rs3.fields("estoque") = "s" then response.write "" end if%><a href="produtos.asp?produto=<%=rs3("idprod")%>"  onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg30%>';return true;" style="color:#FFFFFF;text-decoration:none;"><img src=<%=dirlingua%>/imagens/detalhes.gif border="0"></a></div></td></tr></form>
						</table></td></tr>
						</table></td></tr>
				        </table></td></tr>
<%
...
<table BORDER="0" CELLSPACING="1" CELLPADDING="3"><tr><td bgcolor=#ffffff>
<form action="comprar.asp" method="post" name=comprar<%=rs("idprod")%>>
<table align=center width=260 cellspacing="1" cellpadding="1"><tr><td width=80 height=100><img src="produtos/<%=rs("impeq")%>" width="75" border="0"></td>
<td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%></b><br><br><b><%=strLg29%></b>&nbsp;<%=strLgMoeda & " " & precito%><br><b><%=strLg28%></b> <%if rs("estoque") = "s" then response.write strLg26 else response.write strLg27 end if%>&nbsp;<%=strLg25%><div align=right><br><input type="hidden" name="intProdID" value="<%= intProdID %>"><input type="hidden" name="intQuant" value=1><%if rs.fields("estoque") = "s" then response.write "" end if%>&nbsp;&nbsp;<a href="produtos.asp?produto=<%=rs("idprod")%>"  onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg30%>';return true;" style="color:#FFFFFF;text-decoration:none;"><img src=<%=dirlingua%>/imagens/detalhes.gif border="0"></a></div></td></form></tr></table>
</td></tr></table>
</td></tr></table>
