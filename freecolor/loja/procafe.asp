...
<script LANGUAGE="JScript">
		...
		function amigo(){
				 window.open('enviaamigo.asp?acao=abre&produto=<%=intProdID%>','email','resizable=no,width=270,height=214,scrollbars=no');
				}
					 		...
					 		<table BORDER="0" CELLSPACING="1" CELLPADDING="3" width=565><tr><td bgcolor=#ffffff>
								   <table align=center width=565 cellspacing="1" cellpadding="1"><tr><form action="comprar.asp" method="post" name="registro1"><td><p><font face="<%=fonte%>" style=font-size:17px;color:000000;font-weight:bold><%= strName %></font></b><br><font face="<%=fonte%>" style=font-size:11px;color:000000></p>
								   		  <table border="0" cellspacing="2" cellpadding="4"><tr align=center><td width=150 valign=top align=center><center><img src="produtos/<%=prodinfo("imgra")%>" width=185><br><br><font face="<%=fonte%>" style=font-size:11px;color:000000>
										  		 <table border=0 width=150 align=center><tr><td><font face="<%=fonte%>" style=font-size:11px;color:000000><img src="vista.gif"></td><td><font face="<%=fonte%>" style=font-size:11px;color:006C00><b><%= strlgmoeda & " " & precitovx%></b></td></tr><tr><td><font face="<%=fonte%>" style=font-size:11px;color:000000><img src="prazo.gif"></td><td><font face="<%=fonte%>" style=font-size:14px;color:1F3D3D><b><%=prodinfo("fabricante")%>X</b></font><font face="<%=fonte%>" style=font-size:11px;color:000000> de </font><br><font face="<%=fonte%>" style=font-size:11px;color:b33030><b><%=strlgmoeda & " " & precitonx%></b></font></td></tr></td></tr>
												 </table>
												         <% if prodinfo("parcela") <> "v" then%>
														 ...
														 <%end if%>
															 		&nbsp;<a href="javascript: amigo()" onMouseOut="window.status='';return true;" onMouseOver="window.status='Enviar essa oferta a um amigo!';return true;"><img src=<%=dirlingua%>/imagens/amigo.gif border=0></a></center></font>
