  ...
  <TR>
    ...
    <TD vAlign=top width=566></FORM>
                    ...
                    <TR>
                      <TD vAlign=top align=middle bgColor=#f9f4e6>
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 width=206 border=0>
                          <TBODY>
                          <TR>
                              <TD height=24><MARQUEE behavior= "scroll" align= "center" direction= "up" height="160" width="220" scrollamount= "1" scrolldelay= "40" onmouseover='this.stop()' onmouseout='this.start()'><iframe src="recebido.asp" width="220" height="400" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe></marquee></TD>
                            </TR></TBODY></TABLE>
      ...
      <TABLE height=179 cellSpacing=0 cellPadding=0 width=558 border=0>
        ...
        <TR>
          <TD bgColor=#cecfce>
            <TABLE height=177 cellSpacing=0 cellPadding=0 width=556 align=center 
            border=0>
              <TBODY>
              <TR>
                
              <TD vAlign=top align=middle width=186 bgColor=#F9DC8E> 
                <TABLE height=16 cellSpacing=0 cellPadding=0 width=184 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD><IMG height=5 alt="hospedagem de sites" 
                        src="index_arquivos/d.gif" width=1></TD></TR>
                    <TR>
                      <TD class=noti height=16>
                        <TABLE cellSpacing=0 cellPadding=0 width=176 
                        align=center background=index_arquivos/bg_m.gif 
border=0>
                          <TBODY>
                          <TR>
                            <TD class=noti width=6 height=16>&nbsp;</TD>
                              <TD width=166><A class=text 
                              href="index.asp"><STRONG>Qualidade</STRONG></A></TD>
                            </TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
                  
                <TABLE cellSpacing=0 cellPadding=0 width=160 border=0>
                  <TBODY>
                    <TR> 
                      <TD width=160><div align="center"><img src="qualidadeor.jpg" width="181" height="141"></div></TD>
                    </TR>
                    <TR> 
                      <TD align=middle><div align="justify"><FONT face="Arial, Helvetica, sans-serif" color=#4f4f4f 
      size=1>A Mabella tem um r&iacute;gido controle de qualidade na fabrica&ccedil;&atilde;o, 
                                manuseio, armazenagem e transporte de seus produtos, 
                                que vai desde a sele&ccedil;&atilde;o da mat&eacute;ria 
                                prima, higiene, temperatura e rigoroso treinamento 
                                das pessoas.<br>
                                <font color="#FF0000"><a href="qualidade.asp"><br>
                                </a></font><FONT face="Arial, Helvetica, sans-serif" color=#4f4f4f 
      size=1><font color="#FF0000"><a href="produtos.asp"><img src="tet.gif" width="22" height="22" border="0"></a></font></font><font color="#FF0000"><a href="qualidade.asp"> 
                                Leia mais</a></font></font></div></TD>
                    </TR>
                  </TBODY>
                </TABLE>
              </TD>
...
border=0>
                          ...
                          <TR>
                            <TD class=noti width=6 height=16>&nbsp;</TD>
                              <TD width=166><A class=text 
                              href="index.asp"><STRONG>Produtos</STRONG></A></TD>
                            </TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
                  
                <TABLE cellSpacing=0 cellPadding=0 width=160 border=0>
                  <TBODY>
                    <TR> 
                      <TD width=160><div align="center"><img src="salameio.jpg" width="180" height="141"></div></TD>
                    </TR>
                    <TR> 
                      <TD align=middle><div align="justify"><FONT face="Arial, Helvetica, sans-serif" color=#4f4f4f 
      size=1>A Mabella possui um amplo mix de produtos su&iacute;nos que v&atilde;o 
                                desde carca&ccedil;as, cortes, defumados e processados, 
                                atendendo todo o tipo de necessidade, seja para 
                                a ind&uacute;stria, varejo ou para o consumo final. 
                                <br>
                                <font color="#FF0000"><a href="produtos.asp"><br>
                                <img src="tet.gif" width="22" height="22" border="0"> Leia 
                                mais</a></font></font></div></TD>
                    </TR>
                  </TBODY>
                </TABLE>
              </TD>
              ...
              <TD vAlign=top align=middle width=185 bgColor=#F9DC8E> 
                <TABLE cellSpacing=0 cellPadding=0 width=184 border=0>
                    <TBODY>
                    <TR>
                      <TD><IMG height=5 alt="hospedagem de sites" 
...
border=0>
                          ...
                          <TR>
                            <TD class=noti width=6 height=16>&nbsp;</TD>
                              <TD width=166><A class=text 
                              href="index.asp"><STRONG>Su&iacute;nocultura</STRONG></A></TD>
                            </TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
                  
                <TABLE cellSpacing=0 cellPadding=0 width=160 border=0>
                  <TBODY>
                    <TR> 
                      <TD width=160><div align="center"><img src="porcoorig.jpg" width="181" height="141"></div></TD>
                    </TR>
                    <TR> 
                      <TD align=middle><div align="justify"><FONT face="Arial, Helvetica, sans-serif" color=#4f4f4f 
      size=1>H&aacute; muitas d&eacute;cadas, a suinocultura tem sido uma das 
                                atividades mais importantes e as granjas aplicam 
                                o que h&aacute; de mais moderno em gen&eacute;tica, 
                                controle sanit&aacute;rios, instala&ccedil;&otilde;es 
                                e equipamentos.<br>
                                <font color="#FF0000"><a href="suino.asp"><br>
                                </a></font><FONT face="Arial, Helvetica, sans-serif" color=#4f4f4f 
      size=1><font color="#FF0000"><a href="produtos.asp"><img src="tet.gif" width="22" height="22" border="0"></a></font></font><font color="#FF0000"><a href="suino.asp"> 
                                Leia mais </a></font></font></div></TD>
                    </TR>
                  </TBODY>
                </TABLE>
