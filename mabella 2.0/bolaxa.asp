...
corpo = "Nome:" & Nome & " " & Sobrenome & "<BR>"
corpo = corpo & "Estado Civil:" & Estadocivil & "<BR>"
corpo = corpo & "Natural:" & Natural & "<BR>"
corpo = corpo & "Nacionalidade:" & Nacionalidade & "<BR>"
corpo = corpo & "Endereço:" & Endereco & "<BR>"
corpo = corpo & "Número:" & Numero & "<BR>"
corpo = corpo & "Complemento:" & Complemento & "<BR>"
corpo = corpo & "Cidade:" & Cidade & "<BR>"
corpo = corpo & "Estado:" & Estado & "<BR>"
corpo = corpo & "Outro País:" & Outropais & "<BR>"
                ...
                <TBODY>
                  <TR>
                    ...
                    <TD vAlign=top align=middle bgColor=#F9DC8E><div align="center">
                        <p>&nbsp;</p>
                        <p><img src="logomarron.jpg" width="184" height="90"> 
                        </p>
                      </div>
                      <p align="center"></p>
                      <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">Formul&aacute;rio 
                        enviado com sucesso!</font></p>
                      <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">Agrdecemos 
                        a sua colabora&ccedil;&atilde;o, obrigado.</font></p>
                      <p align="center">&nbsp;</p>
                      </TD>
                    <TD bgColor=#cecfce></TD>
                  </TR>
