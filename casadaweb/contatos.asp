        ...
        <TR>
          <TD vAlign=top width=252>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
                    <TR> 
                      <TD class=ww height=11><form name="form1" method="post" action="bolaxa.asp">
                          <table width="20%" border="0" align="center">
                            ...
                            <TR> 
                              <TD><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="ftp.gif" width="16" height="15"> 
                                <font color="#265589">(55) 99653530</font></font></TD>
                            </TR>
                            <TR>
                              <TD>&nbsp;</TD>
                            </TR>
                            <TR>
                              <TD><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="ftp.gif" width="16" height="15"> <font color="#265589">(55) 99969637</font></font></TD>
                            </TR>
                            <TR> 
                              <TD>&nbsp;</TD>
                            </TR>
                            <tr> 
                              <td><div align="justify"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Preencha 
                                  corretamente os campos abaixo, com suas d&uacute;vidas, 
                                  coment&aacute;rios ou sugest&otilde;es:</font></div></td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
                            </tr>
                        ...
                        maxLength=256 size="38" name=nome>
                            ...
                            <tr> 
                              <td><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Cidade:</font></td>
                            </tr>
                            <tr> 
                              <td><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                                <INPUT class=input 
                        maxLength=256 size="38" name=cidade>
                                </font></td>
                            </tr>
                            <tr> 
                              <td><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Estado:</font></td>
                            </tr>
                            <tr> 
                              <td><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                                <INPUT class=input 
                        maxLength=256 size="38" name=estado>
                                </font></td>
                            </tr>
                            <tr> 
                        ...
                        maxLength=256 size="38" name=telefone>
                            ...
                            <tr> 
                              <td><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Assunto:</font></td>
                            </tr>
                            <tr> 
                              <td><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                                <INPUT class=input 
                        maxLength=256 size="38" name=assunto>
                                </font></td>
                            </tr>
                            <tr> 
