      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
              <TD align=left background=index_arquivos/zpwelcom.gif height=26><img src="121.gif" width="6" height="10"> 
                <strong><font color="#265589" face="Verdana, Arial, Helvetica, sans-serif">WEBSITES</font></strong> 
              </TD>
          </TR></TBODY></TABLE>
        ...
        <TR>
          <TD vAlign=top width=252>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
                    <TR> 
                      <TD class=ww height=11><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>
                        <div align="left"><font color="#336699">Manuten&ccedil;&atilde;o 
                          e acompanhamento </font> </div>
                        </strong> </font> <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Abaixo, 
                          o conjunto de tarefas que desenvolvemos em nosso plano 
                          de manuten&ccedil;&otilde;es:</font></p> <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Criar novos mecanismos de atualiza&ccedil;&otilde;es 
                          e novos servi&ccedil;os aos visitantes sempre que for 
                          necess&aacute;rio. Isto implica em an&aacute;lise, design 
                          e programa&ccedil;&atilde;o do que for considerado priorit&aacute;rio.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Modifica&ccedil;&otilde;es e corre&ccedil;&otilde;es: 
                          uma nova p&aacute;gina necess&aacute;ria, modifica&ccedil;&atilde;o 
                          de endere&ccedil;o/telefone, textos, inclus&otilde;es 
                          e exclus&otilde;es de links, cria&ccedil;&atilde;o de 
                          “banneres” para promover um evento ou &aacute;rea espec&iacute;fica 
                          do site, entre outras tarefas.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Suporte e aux&iacute;lio aos visitantes que porventura 
                          tenham se enganado ou n&atilde;o tenham encontrado o 
                          que desejavam no site.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Checar e revisar permanentemente todos os mecanismos 
                          de atualiza&ccedil;&otilde;es: Corre&ccedil;&otilde;es 
                          necess&aacute;rias, modifica&ccedil;&otilde;es e aperfei&ccedil;oamentos.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Dar o suporte t&eacute;cnico necess&aacute;rio ao uso 
                          de todos os mecanismos de atualiza&ccedil;&otilde;es 
                          presentes no site. Por telefone ou email, durante todo 
                          o hor&aacute;rio comercial.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Garantir a seguran&ccedil;a e integridade das informa&ccedil;&otilde;es.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Inscri&ccedil;&atilde;o do site em mecanismos de busca 
                          da internet para promover as visitas ao site da melhor 
                          forma poss&iacute;vel.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Monitorar permanentemente o tamanho que o site ocupa, 
                          evitando que haja paralisa&ccedil;&atilde;o do site 
                          por exceder sua capacidade. O mesmo tamb&eacute;m quanto 
                          &agrave; taxa de transfer&ecirc;ncia de dados do website.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Ajudar, sempre que necess&aacute;rio, a tratar de assuntos 
                          t&eacute;cnicos pertinentes ao hospedeiro do site e 
                          Fapesp : transfer&ecirc;ncias, upgrades, registros de 
                          dom&iacute;nios, etc ... </font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Mudar ligeiramente a apar&ecirc;ncia do site sempre 
                          que for necess&aacute;rio.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Controlar, monitorar e prever o n&uacute;mero de acessos 
                          do site: Fornecimento de relat&oacute;rios estat&iacute;sticos 
                          completos nos &uacute;ltimos dias de cada m&ecirc;s.</font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          Sugest&otilde;es de mudan&ccedil;as e aperfei&ccedil;oamentos 
                          levando em considera&ccedil;&atilde;o as caracter&iacute;sticas 
                          t&eacute;cnicas do site e seu uso efetivos.</font></p>
                        <p><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><br>
                          </font><font color="#265589" size="1"> </font> </p>
                        <p><a href="websites.asp"><img src="13.gif" width="20" height="11" border="0">O 
                          que &eacute; ? Como funciona ?</a></p>
                        <p><a href="metodologia.asp"><img src="13.gif" width="20" height="11" border="0">Metodologia 
                          empregada</a></p>
                        <p><br>
                        </p>
                        </TD>
