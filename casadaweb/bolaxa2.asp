...
corpo = "<div align=""center""><font size=""2"" face=""Verdana, Arial, Helvetica, sans-serif"">Formulário de contatos do site da Casa da Web!</font></div><br><br><font size=""1"" face=""Verdana, Arial, Helvetica, sans-serif""><b>Nome:</b>" & Nome & "<BR>"
...
corpo = corpo & "<b>Serviços:</b>" & Sitenovo & "<BR>"
corpo = corpo & "<b>Serviços:</b>" & Hospedagem & "<BR>"
corpo = corpo & "<b>Serviços:</b>" & Manutencao & "<BR>"
corpo = corpo & "<b>Serviços:</b>" & Inclusao & "<BR>"
corpo = corpo & "<b>Serviços:</b>" & Formularios & "<BR>"
corpo = corpo & "<b>Serviços:</b>" & Criacao & "<BR>"
corpo = corpo & "<b>Registro de Domínio:</b>" & Dominio & "<BR>"
corpo = corpo & "<b>Endereço atualização:</b>" & Web & "<BR>"
corpo = corpo & "<b>Outros serviços:</b>" & Outros & "<BR>"
corpo = corpo & "<b>O site será:</b>" & Anima & "<BR>"
corpo = corpo & "<b>O site será:</b>" & Dinamico & "<BR>"
