      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
              <TD align=left background=index_arquivos/zpwelcom.gif height=26><img src="121.gif" width="6" height="10"> 
                <strong><font color="#265589" face="Verdana, Arial, Helvetica, sans-serif">SSS</font></strong></TD>
          </TR></TBODY></TABLE>
        ...
        <TR>
          <TD vAlign=top width=252>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                      <TD class=ww height=11> <P align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>SSS</strong> 
                          - Sistema de Solicita&ccedil;&atilde;o de Servi&ccedil;os 
                          Online, com este sistema voc&ecirc; cliente pode organizar 
                          todas as tarefas realizadas pela sua empresa atrav&eacute;s 
                          de um software totalmente desenvolvido em Web podendo 
                          ser acompanhado online por diversos setores da empresa, 
                          com acompanhamento em tempo real com Acesso Restrito..</font></P>
                        <P align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Caracter&iacute;sticas:</font></P>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="setinha.gif" width="7" height="7"> 
                          cadastro de usu&aacute;rios e administradores;<br>
                          <img src="setinha.gif" width="7" height="7"> cadastros 
                          de clientes;<br>
                          <img src="setinha.gif" width="7" height="7"> postagem 
                          de tarefas;<br>
                          <img src="setinha.gif" width="7" height="7"> monitoramento 
                          de tarefas(Concluidas, Em processo, Fechadas);<br>
                          <img src="setinha.gif" width="7" height="7"> agenda 
                          de telefones;<br>
                          <img src="setinha.gif" width="7" height="7"> download 
                          de relat&oacute;rio resumido, (Excel, PDF e envio por 
                          e-mail);<br>
                          <img src="setinha.gif" width="7" height="7"> calend&aacute;rio 
                          monitorado;<br>
                          <img src="setinha.gif" width="7" height="7"> alarme 
                          para tarefas agendadas;<br>
                          <img src="setinha.gif" width="7" height="7"> upload 
                          de arquivos;<br>
                          <img src="setinha.gif" width="7" height="7"> busca avan&ccedil;ada 
                          em todos os setores;<br>
                          </font></p>
                        <p align="left"><font color="#265589" size="1" face="Verdana, Arial, Helvetica, sans-serif">Entre 
                          em contato conosco agora mesmo para ter em suas m&atilde;os 
                          este sistema para organizar a sua empresa em diversar 
                          &aacute;reas utilizando a internet.</font></p>
                        <p align="left">&nbsp;</p>
                        <p><font color="#336699">FA&Ccedil;A SEU PEDIDO <a href="contatos.asp">CLICANDO 
                          AQUI!</a></font></p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p><font color="#265589" face="Verdana, Arial, Helvetica, sans-serif"><a href="http://www.macromedia.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" target=_blank><img src="flash.gif" width="20" height="20" border="0"> 
                          Instalar Flash Player</a></font><br>
                        </p>
