...
%>
<table width="106" align="center"><tr><td><div align="center"><span class="style3"><a class=menu href="default.asp?d=<%= Directory %>\" target=_blank><img src="marca.gif" border="0" /><br /><% RS("ImageName") %></a></span></div><br /></td></tr></table>
<%
