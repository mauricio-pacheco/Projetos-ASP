...
TotalRecs = rs.recordcount
   ...
   %>
                  ...
                  <p align="left" class="fontedestaque"><font face="Verdana, Arial, Helvetica, sans-serif">Not&iacute;cia 
                    postada em </font><font face="Arial, Helvetica, sans-serif">
                            <% =date1 %>
                          </font></p>
                  <p align="left" class="fontemenor" style="color: #434343"><font face="Verdana"><b>Assunto:
                        <% =name1 %>
                  </b></font></p>
                  ...
                  <table width="12%" border="0">
                    <tr>
                      <td><div align="center"><a href="not.asp" style="color: #434343"><img src="seta9.gif" width="8" border="0" height="8"></a></div></td>
                      <td><div align="center"><span style="font-size: 9px"><font face="Verdana"><a href="not.asp" style="color: #434343">Voltar</a></font></span></div></td>
                    </tr>
                  </table>
                  </TD>
              </TR>
