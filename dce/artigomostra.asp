          ...
          <TD align=middle>
            <TABLE width=482 border=0 align="center" cellPadding=0 cellSpacing=0>
              ...
              <TR>
                <TD height=10></TD></TR>
              <TR>
                <TD class=fontedestaque><table width="297" border="0">
                  <tr>
                    <td width="20"><a href="artigos.asp"><img src="artigo2.gif" width="20" height="15" border="0"></a></td>
                    <td width="267" class=fonte><p><a href="artigos.asp">&nbsp;ENVIE O SEU ARTIGO</a></p>
                      </td>
                  </tr>
                </table>
...
RS.PageSize = 15 'quantidade de registros por página. Você pode alterar sem conforme precise.
...
If RS("autoriza") = "s" then
   ...
   Response.Write ("<strong>&raquo;</strong>&nbsp;<a href='notart.asp?id=" & id & "' target=_top>")
...
IF intpagina > 1 then 
   %>
                    ...
                    <br>
                      ...
                      <a href="artigomostra.asp?pagina=<%=intpagina-1%>"><img border="0" src="seta1152.gif" width="7" height="7">&nbsp;Anterior</a> 
                      <% 
END IF
...
%> 
                      <a href="artigomostra.asp?pagina=<%=intpagina + 1%>">Próxima&nbsp;<img border="0" src="seta115.gif" width="7" height="7"></a> 
       <% 
END IF
%>
